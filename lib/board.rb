...
class Board
    ...
    def set_up()
        ...
        @array[1][0] = Pawn.new(1,0, @player2.player_number)
        @array[1][1] = Pawn.new(1,1, @player2.player_number)
        @array[1][2] = Pawn.new(1,2, @player2.player_number)
        @array[1][3] = Pawn.new(1,3, @player2.player_number)
        @array[1][4] = Pawn.new(1,4, @player2.player_number)
        @array[1][5] = Pawn.new(1,5, @player2.player_number)
